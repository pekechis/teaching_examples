<!--
    ...
    Description: Creating a CHESS using PHP Loops AND CSS3
    Date: October
...
<html lang="en">
  <head>
    ...
    <title>CHESS BOARD WITH PHP LOOPS AND CSS3</title>
    <link rel="stylesheet" type="text/css" href="style_chess_css3.css">
  </head>
  <body>
